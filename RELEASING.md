...
2. Edit by hand every file that writes the version out: `README.md`, `docs/build-tools.md`, `skills/spider-sense/SKILL.md` (`metadata.version` and the plugin line in the table) and `skills/spider-sense/references/running.md`.
