...
A mark is one row in the store, shared like everything else, and swept with the retention.
...
`--since=start` therefore works without anyone running `mark`, and it covers the current run.
