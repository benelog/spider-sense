...
| writes the Spider Sense block into the project's `CLAUDE.md` and installs the skill
...
`init` writes the Spider Sense block into the project's `CLAUDE.md` and installs the skill into its `.claude/skills/`.
