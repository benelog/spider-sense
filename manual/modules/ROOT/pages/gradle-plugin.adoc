...
It writes the Spider Sense block into the project's `CLAUDE.md` and installs the skill into `.claude/skills/`, as xref:agent-skill.adoc#init[The Agent Skill] describes.
