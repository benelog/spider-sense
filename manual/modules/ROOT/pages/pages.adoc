...
The table gives the statement in monospace on one line, with the full text in its tooltip, then the system chip, the operation, the table, calls, avg, p95, max, total, the slow calls (in the accent colour when there are any), and when it was last seen.
