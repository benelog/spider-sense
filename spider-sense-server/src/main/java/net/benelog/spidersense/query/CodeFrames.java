...
public final class CodeFrames {
    ...
    /**
     * The frame a span's own attributes name, when an instrumentation set them.
     *
     * <p>There is no file and no line in these, so the frame is
     * {@code namespace.function}: still enough to open the right class.
     */
